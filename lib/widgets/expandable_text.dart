...
class _ExpandableTextWidgetState extends State<ExpandableTextWidget> {
  ...
  double textHeight = Dimensions.screenHeight/6.9;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty?SmallText(height: 1.7, color: AppColors.paraColor, size:Dimensions.font16, text: firstHalf):Column(
        children: [
          SmallText(color: AppColors.paraColor, size:Dimensions.font16, height: 1.7, text: hiddenText?(firstHalf+"..."):(firstHalf+secondHalf)),
          InkWell(
            onTap: (){
              setState((){
